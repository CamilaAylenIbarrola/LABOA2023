public class Libro {
    ...
    private EditorialLibro editorial;
    ...
    public Libro(String titulo, Persona autor, int isbn, int cantpags, EditorialLibro editorial, Fecha fPublicacion){
        this.titulo= titulo;
        this.autor= autor;
        this.isbn= isbn;
    ...
    public Libro(String titulo, Persona autor, EditorialLibro editorial){
        this.titulo= titulo;
        this.autor= autor;
        this.editorial= editorial;
    }
    ...
    public void setEditorial(EditorialLibro editorial) {
        this.editorial = editorial;
    }
